...
<body>
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex justify-content-center flex-grow-1">
            <form class="form-inline">
                <input class="form-control mr-sm-2" type="search" placeholder="Buscar" aria-label="Search" style="width:600px;">
    ...
    <nav class="navbar navbar-light" style="background-color: #e3f2fd;">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-nav mr" href="index.html">Inicio</a>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="#">Mantenimiento de computadoras</a>
                    <a class="dropdown-item" href="#">Instalación de programas</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#">Licencias de programas</a>
                </div>
                </li>
                <li class="nav-item">
